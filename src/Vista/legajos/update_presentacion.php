...
$vars_template = [];
$vars_vista['SUBTITULO'] = 'Modificar Presentación';
...
if($anticorrupcion->archivo) {
	$campos_presentacion['ARCHIVO'][0] =  ['URL' => \App\Helper\Vista::get_url("index.php/legajos/mostrar_presentacion/{$anticorrupcion->id_presentacion}")];		
}
