...
$vars_template = [];
$vars_vista['SUBTITULO'] = 'Modificar Evaluación';
...
$campos_evaluacion = [
	...
	'ACTO' => $evaluacion->acto_administrativo,
	'PUNTAJE' => $evaluacion->puntaje,
];

if($evaluacion->archivo) {
	$campos_evaluacion['ARCHIVO'][0] =  ['URL' => \App\Helper\Vista::get_url("index.php/legajos/mostrar_evaluacion/{$evaluacion->id}")];		
}
...
$vars_template['BOTON_VOLVER'][] = ['VOLVER' => \App\Helper\Vista::get_url("index.php/legajos/historial_evaluacion/{$empleado->cuit}") , 'BLOQUE' =>\App\Helper\Bloques::PERFILES_PUESTO, 'ID' => "volver_legajo", 'CLASS' => "btn btn-default", 'HREF' => "#"];
