...
$vars_template['LINK'] = \App\Helper\Vista::get_url('index.php/escalafon/situacion_revista');
$sit_revista = new \FMT\Template(TEMPLATE_PATH.'/escalafon/lista_situacion_revista.html',$vars_template,['CLEAN'=>false]);
$vars_vista['SUBTITULO'] = "Situación de Revista";
$vars_vista['JS_FOOTER'][]['JS_SCRIPT'] = \App\Helper\Vista::get_url('ajax_situacion_revista.js');
...
$vars_vista['CONTENT'] = "$sit_revista";
