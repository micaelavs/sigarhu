...
$vars_template['LINK'] = \App\Helper\Vista::get_url('index.php/presupuestos/saf');
$pre_saf = new \FMT\Template(TEMPLATE_PATH.'/presupuestos/lista_presupuesto_saf.html',$vars_template,['CLEAN'=>false]);

$vars_vista['SUBTITULO'] = "Listado de Códigos SAF";
$vars_vista['JS_FOOTER'][]['JS_SCRIPT'] = \App\Helper\Vista::get_url('ajax_pre_saf.js');
