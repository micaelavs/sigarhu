...
$vars_template['LINK'] = \App\Helper\Vista::get_url('index.php/presupuestos/programas');
$pre_programas = new \FMT\Template(TEMPLATE_PATH.'/presupuestos/lista_presupuesto_programas.html',$vars_template,['CLEAN'=>false]);
$vars_vista['SUBTITULO'] = "Listado de Códigos de Programas";
$vars_vista['JS_FOOTER'][]['JS_SCRIPT'] = \App\Helper\Vista::get_url('ajax_pre_programas.js');
...
$vars_vista['CONTENT'] = "$pre_programas";
