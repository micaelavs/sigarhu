...
$vars_template['LINK'] = \App\Helper\Vista::get_url('index.php/presupuestos/am_presupuesto');
$presupuestos = new \FMT\Template(TEMPLATE_PATH.'/presupuestos/index.html',$vars_template,['CLEAN'=>false]);
$vars_vista['SUBTITULO'] = "Presupuestos";
...
$vars_vista['CONTENT'] = "$presupuestos";
