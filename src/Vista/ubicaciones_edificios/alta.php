...
use FMT\Vista;
	...
	$vars_vista['SUBTITULO']		= 'Alta de Edificios';
    ...
    $vars_template['CALLE']			=  $ubicaciones_edificios->calle;
    $vars_template['NUMERO']		=  $ubicaciones_edificios->numero;
    ...
    $vars_template['COD_POSTAL']	=  $ubicaciones_edificios->cod_postal;
